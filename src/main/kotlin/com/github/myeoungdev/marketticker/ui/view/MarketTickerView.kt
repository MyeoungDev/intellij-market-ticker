...
class MarketTickerView(
    ...
    private fun setupUI() {
        ...
        mainTabs.addTab(TabInfo(stockPanel).setText(localizationService.text("주식", "Stocks")))
        mainTabs.addTab(TabInfo(screenerView).setText(localizationService.text("스크리너", "Screener")))
        mainTabs.addTab(TabInfo(marketIndicatorsView).setText(localizationService.text("주요 지표", "Major Indicators")))
        mainTabs.addTab(TabInfo(newsView).setText(localizationService.text("뉴스", "News")))
        mainTabs.addTab(TabInfo(researchView).setText(localizationService.text("리서치", "Research")))
        mainTabs.addTab(TabInfo(calendarView).setText(localizationService.text("캘린더", "Calendar")))
